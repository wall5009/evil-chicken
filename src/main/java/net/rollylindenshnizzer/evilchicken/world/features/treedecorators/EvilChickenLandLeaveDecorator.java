...
public class EvilChickenLandLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<EvilChickenLandLeaveDecorator> CODEC = MapCodec.unit(EvilChickenLandLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("evil_chicken:evil_chicken_land_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public EvilChickenLandLeaveDecorator() {
		super(0.25f);
	}
