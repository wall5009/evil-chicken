...
public class EvilChickenLandTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<EvilChickenLandTrunkDecorator> CODEC = MapCodec.unit(EvilChickenLandTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("evil_chicken:evil_chicken_land_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
